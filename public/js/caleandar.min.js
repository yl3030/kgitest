function createCalendar(e, t, a) {
  ...
  function l() {
    ...
    var todayMonth = s[e.Selected.Month];
    var monthText;
    if(todayMonth == 'January') {
        monthText = "一月";
    }else if(todayMonth == 'Feburary') {
        monthText = "二月";
    }else if(todayMonth == 'March') {
        monthText = "三月";
    }else if(todayMonth == 'April') {
        monthText = "四月";
    }else if(todayMonth == 'May') {
        monthText = "五月";
    }else if(todayMonth == 'June') {
        monthText = "六月";
    }else if(todayMonth == 'July') {
        monthText = "七月";
    }else if(todayMonth == 'August') {
        monthText = "八月";
    }else if(todayMonth == 'September') {
        monthText = "九月";
    }else if(todayMonth == 'October') {
        monthText = "十月";
    }else if(todayMonth == 'November') {
        monthText = "十一月";
    }else if(todayMonth == 'December') {
        monthText = "十二月";
    }
    if (
      ((l.className += " today " + todayMonth),
      (l.innerHTML = monthText + ", " + e.Selected.Year),
      a.appendChild(l),
      e.Options.NavShow && !e.Options.NavVertical)
    ) {
